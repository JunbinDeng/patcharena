...
def extract_patch(workspace: Path, patch_file: Path, excluded_paths: list[str] | None = None) -> PatchStats:
    ...
    shortstat_text = _run_git(["git", "diff", "--shortstat", *pathspec_args(excluded_paths)], workspace)
